...
const importedListingImageMetadata: Array<{
  ...
  {
    seq: "042",
    alt: "Expansive studio living zone near the double garage, with kitchenette and adjoining toilet/vanity area, currently set up with dining and lounge spaces",
    category: "Interiors",
  },
